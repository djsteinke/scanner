...
def main():
    ...
    path = input_path + '\\scan\\' + dataname + '\\' + dataname + ".xyzrgb"
    pathXYZ = input_path + '\\scan\\' + dataname + '\\' + "xyz.xyz"
    xyz = open(input_path + '\\scan\\' + dataname + '\\' + dataname + ".xyzrgb", mode="r")
    points = []
    for line in xyz:
    ...
    print(points[1])
    a = np.array(points)
    pcd = o3d.io.read_point_cloud(input_path + '\\scan\\' + dataname + '\\' + dataname + ".xyzrgb", format='xyzrgb')
