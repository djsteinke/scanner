...
class Calibration(object):
    ...
    def load(self):
        ...
        if os.path.isfile(file):
            ...
            self.b2 = self.camera_calibration.undistort_img(cv2.imread(f'{self.path}\\calibration_B2.jpg'))
            ...
            self.f2 = self.camera_calibration.undistort_img(cv2.imread(f'{self.path}\\calibration_F2.jpg'))
            self.c0 = self.camera_calibration.undistort_img(cv2.imread(f'{self.path}\\calibration_C0.jpg'))
            self.c1 = self.camera_calibration.undistort_img(cv2.imread(f'{self.path}\\calibration_C1.jpg'))
            self.c2 = self.camera_calibration.undistort_img(cv2.imread(f'{self.path}\\calibration_C2.jpg'))
            self.get_scalar()
            self.get_c()
        self.set_slope()
